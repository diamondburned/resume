...
\usepackage[default,oldstyle,proportional]{lato}
\usepackage[]{josefin}
...
%----------HEADING----------
\renewcommand{\faHeader}[1]{\raisebox{-0.05\height}{\faicon{#1}}}
...
\begin{center}
  ...
  \vspace{4pt}
  \href{mailto:<.email>}{\small{\faHeader{envelope-o} \ul{<.email>}}} $|$
  \href{https://github.com/<.github>}{\small{\faHeader{github} \ul{<.github>}}} $|$
  \href{https://<.website>}{\small{\faHeader{link} \ul{<.website>}}} $|$
  \href{https://linkedin.com/in/<.linkedin>}{\small{\faHeader{linkedin-square} \ul{<.name>}}}
  <end>
\end{center}
...
\section{PROJECTS}
  \resumeSubHeadingListStart
    ...
    \item{
      \begin{tabular*}{0.965\textwidth}[t]{l @{\extracolsep{\fill}} r}
        {\textbf{<.name>} | \small{<conv.Join .keywords ", ">}} &
